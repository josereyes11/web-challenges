...
console.log(everyEmployeeHasPhoneNumber);
console.log(employeeLouise33?.city);
console.log(ednaInvestment?.city);
console.log(employeesSortedByLastName?.[0]?.city);
console.log(employeeWithId?.city);
console.log(employeesSortedByAge?.[0]?.city);
